...
| metric | value |
|---|---:|
| `coop_mod/*.scr` files | 110 |
| total lines in `coop_mod/` | 66,531 |
...
| `aihandler.scr` | 1,382 | 21 | [200] Smithy - this script is called every time an actor enters the world by exec it on their tiki (via share… |
...
| `dbno.scr` | 1,257 | 3 | safety-net: make sure the cgame "downed" view flag is cleared on (re)spawn, so a player who died while |
| `dbno_test.scr` | 3 | 1 |  |
...
| `itemhandler.scr` | 3,033 | 35 | [200] Smithy - this script is called every time an item enters the world by exec it on their tiki |
...
| `loadoutpick.scr` | 615 | 0 | [310] HZM coop ARMORY - per-player loadout picks (Phase 1). |
| `loadoutroster.scr` | 775 | 1 | GENERATED by scratchpad/gen_loadout3.py -- DO NOT HAND-EDIT (regenerate instead) |
...
| `main.scr` | 2,089 | 21 | VERSION 1.0 started by chrissstrahl on 2018.06.28 |
...
| `player.scr` | 1,761 | 6 | started by chrissstrahl on 2020.10.16 ([202]) |
| `precache.scr` | 186 | 0 |  |
...
| `sndcache.scr` | 728 | 1 | HZM coop - voice-pool precache (bug-1141 lag spikes). GENERATED by gen_sndcache.py |
...
| `tinnitus.scr` | 196 | 1 | HZM coop - TINNITUS / MUFFLED HEARING (per-player). |
| `tracescan.scr` | 132 | 1 | coop_mod/tracescan.scr - server-side collision grid scanner (dev tool) |
| `variables.scr` | 298 | 5 | started by chrissstrahl on 2020.10.16 ([202]) |
...
| `weaponstate.scr` | 107 | 0 | [200] Smithy |
