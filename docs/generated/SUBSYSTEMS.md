...
| total lines in `coop_mod/` | 72,441 |
...
| `aihandler.scr` | 1,691 | 24 | [200] Smithy - this script is called every time an actor enters the world by exec it on their tiki (via share… |
...
| `itemhandler.scr` | 3,720 | 36 | [200] Smithy - this script is called every time an item enters the world by exec it on their tiki |
...
| `loadoutskins.scr` | 487 | 1 | GENERATED by build_finish_strip.py + gen_skins.py - the server-side skin variant table. |
| `loadoutskins_base.scr` | 382 | 1 | GENERATED by docs/tools/gen_skinbase.py from loadoutskins.scr - DO NOT EDIT. |
