...
| total lines in `coop_mod/` | 71,336 |
...
| `loadoutpick.scr` | 923 | 0 | [310] HZM coop ARMORY - per-player loadout picks (Phase 1). |
| `loadoutroster.scr` | 844 | 1 | GENERATED by scratchpad/gen_loadout3.py -- DO NOT HAND-EDIT (regenerate instead) |
| `loadoutskins.scr` | 394 | 1 | GENERATED by build_finish_strip.py + gen_skins.py - the server-side skin variant table. |
