...
| total lines in `coop_mod/` | 71,593 |
...
| `loadoutskins.scr` | 475 | 1 | GENERATED by build_finish_strip.py + gen_skins.py - the server-side skin variant table. |
...
| `officer.scr` | 4,814 | 27 | Officer Boss + Radio Station |
