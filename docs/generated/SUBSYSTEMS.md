...
| total lines in `coop_mod/` | 72,969 |
...
| `aihandler.scr` | 1,864 | 26 | [200] Smithy - this script is called every time an actor enters the world by exec it on their tiki (via share… |
...
| `loadoutskins.scr` | 579 | 1 | GENERATED by build_finish_strip.py + gen_skins.py - the server-side skin variant table. |
| `loadoutskins_base.scr` | 413 | 1 | GENERATED by docs/tools/gen_skinbase.py from loadoutskins.scr - DO NOT EDIT. |
