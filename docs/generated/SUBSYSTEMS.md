...
| total lines in `coop_mod/` | 69,413 |
...
| `challenges.scr` | 3,593 | 27 | [303] HZM CHALLENGES / ACHIEVEMENTS SYSTEM - Phase 1 (tracking + persistence + unlocks + HUD toast + review) |
...
| `loadoutpick.scr` | 730 | 0 | [310] HZM coop ARMORY - per-player loadout picks (Phase 1). |
...
| `variables.scr` | 305 | 5 | started by chrissstrahl on 2020.10.16 ([202]) |
