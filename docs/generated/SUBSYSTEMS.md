...
| total lines in `coop_mod/` | 78,874 |
...
| `mp.scr` | 385 | 2 | MP.SCR - the multiplayer entry point. NOT the coop framework. |
| `mp_armory.scr` | 479 | 5 | MP_ARMORY.SCR - the shared MP armory dispatcher (slice 2, LIVE). |
