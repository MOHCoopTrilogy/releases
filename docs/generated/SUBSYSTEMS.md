...
| total lines in `coop_mod/` | 71,281 |
...
| `challenges.scr` | 3,762 | 27 | [303] HZM CHALLENGES / ACHIEVEMENTS SYSTEM - Phase 1 (tracking + persistence + unlocks + HUD toast + review) |
...
| `loadoutpick.scr` | 882 | 0 | [310] HZM coop ARMORY - per-player loadout picks (Phase 1). |
| `loadoutroster.scr` | 844 | 1 | GENERATED by scratchpad/gen_loadout3.py -- DO NOT HAND-EDIT (regenerate instead) |
| `loadoutskins.scr` | 380 | 1 | GENERATED by build_finish_strip.py + gen_skins.py - the server-side skin variant table. |
...
| `variables.scr` | 319 | 5 | started by chrissstrahl on 2020.10.16 ([202]) |
