...
|---|---|---|---|
| Engine juke/hide-timer overrides **and** AI maneuver mover | `coop_aiDynamic` | `main.scr:247`, `:250` | maneuver mover = "SHIPPED-VERIFIED" |
| Squad brain + last-known search | `coop_aiSquad`, `coop_aiSearch` | `main.scr:255` | "steps 3-4 TODO" |
| Squad morale break | `coop_moraleEnable` | `main.scr:257` | "shipped, default 0" |
| Tactical retreat | `coop_retreatEnable` | `wounded.scr` | "shipped, default 0" |
