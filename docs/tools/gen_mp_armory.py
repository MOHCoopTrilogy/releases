...
def record_urc():
    ...
    L = [
        "// HZM MP SERVICE RECORD - GENERATED by docs/tools/gen_mp_armory.py - DO NOT HAND-EDIT.",
        "// The progression ladder, laid out so it is CLEARLY DEFINED (user 2026-09-15): rank + total,",
        "// each class's kills / the %d-kill unlock with an UNLOCKED badge, and the cosmetic ladder. All" % unlock,
        "// numbers are parsed from mp_progression.scr / mp_cosmetics.scr so they match what the server",
        "// enforces. Values are client cvars pushed by mp_progression.scr::applyUnlocks. No vstr.",
    ...
    L += cap("caption", (96, 56, 448, 24), "MP SERVICE RECORD", fg="0.84 0.82 0.76 1.00",
             font="facfont-20", align="xcenter")
    # header: rank + total
    L += cap("rankCap", (120, 92, 70, 16), "RANK")
